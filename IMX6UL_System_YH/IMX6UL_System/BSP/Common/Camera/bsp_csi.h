...
/* Includes ------------------------------------------------------------------*/
//#include <Common/camera/bsp_ov5640.h>
...
#define APP_FRAME_BUFFER_COUNT 3
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
//status_t OV5640_WriteReg(u32 iic,u16 reg,u8 val);
//status_t OV5640_ReadReg(u32 iic,u16 reg,u8 *val);
