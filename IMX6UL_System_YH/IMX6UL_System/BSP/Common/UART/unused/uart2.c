...
#define UART_BASE 			LPUART2
#define UART_CLK_FREQ 		GetUartSrcClock()
#define UART_IRQn 			LPUART2_IRQn
#define UART_IRQHandler 	LPUART2_IRQHandler
#define UART_PortInit 		UART2_Pin_Init
...
const struct uart_ops UART2_ops=
{
	uart_open,
	uart_close,
	uart_set_cfg,
